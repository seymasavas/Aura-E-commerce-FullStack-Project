import { 
  Heart, Instagram, LucideFacebook, LucideMenu, LucideYoutube, 
  MailIcon, PhoneIcon, Search, ShoppingCart, Twitter, UserIcon 
} from "lucide-react";
          ...
          <div className="w-full flex justify-between items-center">
            ...
            <div className="flex gap-[20px]">
              ...
              <div className="flex items-center gap-[5px]">
                ...
                <h6 className="font-[700] text-sm text-white">michelle.rivera@example.com</h6>
              </div>
            </div>

            <div>
              <h6 className="font-[700] text-sm text-white">Follow Us and get a chance to win 80% off</h6>
            </div>
        ...
        <div className="flex flex-col w-full">
          ...
          <div className="w-full px-[20px] lg:px-[35px] h-[80px] flex items-center justify-between">
            ...
            <div className="flex items-center gap-[80px]">
                ...
                <Link to="/" className="font-sans font-[700] text-3xl tracking-[0.1px] text-[#252B42]">
                  Aura
                </Link>
                ...
                <div className="hidden lg:flex items-center">
                  <nav className="flex gap-[20px] font-sans font-[700] text-sm text-[#737373]">
                    ...
                    <div className="group relative flex items-center gap-1 cursor-pointer ">
                          ...
                          <ChevronDown size={14} className="text-[#737373] group-hover:text-[#252B42] transition-colors" />
                          ...
                          <div className="absolute top-full left-0 w-[150px] bg-white shadow-lg rounded-md py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50 border border-gray-100">
                              ...
                              <Link to="/team" className="block px-4 py-2 text-[14px] font-bold text-[#737373] hover:bg-gray-50 hover:text-[#23A6F0]">
                                  Team
                              </Link>
                              
                              <Link to="/pricing" className="block px-4 py-2 text-[14px] font-bold text-[#737373] hover:bg-gray-50 hover:text-[#23A6F0]">
                                  Pricing
                              </Link>
            ...
            <div className="flex items-center">
                ...
                <div className="hidden lg:flex items-center gap-[30px] text-[#23A6F0] font-sans font-[700] text-sm">
                  <Link to="/login" className="flex items-center gap-[5px] hover:text-blue-600">
                    <UserIcon className="w-[16px] h-[16px]" /> Login / Register
                  </Link>
          ...
          <div className="lg:hidden flex flex-col items-center justify-center py-8 gap-8">
            <nav className="flex flex-col items-center gap-[30px] font-sans font-[400] text-[30px] text-[#737373]">
              <Link to="/" className="text-[#252B42] font-medium">Home</Link>
